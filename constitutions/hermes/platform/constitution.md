...
# Platform Service Constitution

This constitution defines governance rules for the **Platform** service within the `hermes` domain.

## Scope

Applies to all repositories within the `hermes/platform` service.
...
Update it to reflect the specific governance needs of the Platform service.
