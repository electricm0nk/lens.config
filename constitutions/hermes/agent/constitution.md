...
# agent Service Constitution

This constitution defines governance rules for the **agent** service within the `hermes` domain.

## Scope

Applies to all repositories within the `hermes/agent` service.
...
Update it to reflect the specific governance needs of the agent service.
