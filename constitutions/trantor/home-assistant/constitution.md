...
# home-assistant Service Constitution

This constitution defines governance rules for the **home-assistant** service within the `trantor` domain.

## Scope

Applies to all repositories within the `trantor/home-assistant` service.
...
Update it to reflect the specific governance needs of the home-assistant service.
